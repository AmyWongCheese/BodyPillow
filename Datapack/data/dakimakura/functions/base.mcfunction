...
execute as @a if predicate dakimakura:base/mainhand_is_sneaking run item entity @p weapon.mainhand replace item_frame{display:{Name:'{"translate":"item.dakimakura.base.name","italic":false}',Lore:['[{"text":"item.dakimakura.base.lore1","italic":false}]','{"text":"item.dakimakura.base.lore2","italic":false}']},CustomModelData:34352,EntityTag:{Silent:1b,Tags:["dakimakura"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:34352,dakimakura:1}},Invisible:1b}} 1
execute as @a if predicate dakimakura:base/offhand_is_sneaking run item entity @p weapon.offhand replace item_frame{display:{Name:'{"translate":"item.dakimakura.base.name","italic":false}',Lore:['[{"text":"item.dakimakura.base.lore1","italic":false}]','{"text":"item.dakimakura.base.lore2","italic":false}']},CustomModelData:34352,EntityTag:{Silent:1b,Tags:["dakimakura"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:34352,dakimakura:1}},Invisible:1b}} 1
