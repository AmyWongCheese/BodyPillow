...
execute as @a if predicate dakimakura:13/mainhand_is_sneaking run item entity @p weapon.mainhand replace item_frame{display:{Name:'{"translate":"item.dakimakura.pillow.13.name","italic":false}',Lore:['[{"text":"item.dakimakura.pillow.13.lore1","italic":false}]','{"text":"item.dakimakura.pillow.13.lore2","italic":false}']},CustomModelData:343528,EntityTag:{Silent:1b,Tags:["dakimakura"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:343528,dakimakura:1}},Invisible:1b}} 1
execute as @a if predicate dakimakura:13/offhand_is_sneaking run item entity @p weapon.offhand replace item_frame{display:{Name:'{"translate":"item.dakimakura.pillow.13.name","italic":false}',Lore:['[{"text":"item.dakimakura.pillow.13.lore1","italic":false}]','{"text":"item.dakimakura.pillow.13.lore2","italic":false}']},CustomModelData:343528,EntityTag:{Silent:1b,Tags:["dakimakura"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:343528,dakimakura:1}},Invisible:1b}} 1

#replace pillow for bed to pillow 
execute as @a if predicate dakimakura:13/mainhand_bed_not_sneaking run loot replace entity @p weapon.mainhand loot dakimakura:pillow/13
execute as @a if predicate dakimakura:13/offhand_bed_not_sneaking run loot replace entity @p weapon.offhand loot dakimakura:pillow/13
