...
execute as @a if predicate dakimakura:8/mainhand_bed_not_sneaking run loot replace entity @p weapon.mainhand loot dakimakura:pillow/8
execute as @a if predicate dakimakura:8/offhand_bed_not_sneaking run loot replace entity @p weapon.offhand loot dakimakura:pillow/8
